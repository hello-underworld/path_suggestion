...
class Pathfinder:
    ...
    def __init__(self,cc):
        ...
        """
        self.cc = cc
        self.fully_li_struct = self.prop_struct()[0]
        self.li_pos = self.prop_struct()[1]
        self.only_li_struct = self.only_li_struct()
    ...
    def prop_struct(self):
        ...
        tmp_struct, li_pos = sites.populate_Li(nsites=num_possible_li)
    ...
    def only_li_struct(self):
        ...
        tmp_struct = self.tmp_struct
        li_pos = self.li_pos
        only_li_struct = Structure(tmp_struct.lattice, ['Li']*len(li_pos), li_pos)
    ...
    def partially_li_struct(self,index_numbers):
        ...
        ori_struct = self.cc.structure.as_dict()
        inserts = self.fully_li_struct.as_dict()['sites'][index_numbers]
        ori_struct['sites'][:].expend(inserts)
        return Structure.from_dict(ori_struct)
    ...
    def pop_struct_to(self, fmt, filename):
        ...
        self.tmp_struct.to(fmt=fmt, filename=filename)